...
fix-proxy:
	...
	powershell -NoProfile -ExecutionPolicy Bypass -File scripts/ensure-proxy-health.ps1

ensure-direct:
	powershell -NoProfile -ExecutionPolicy Bypass -File scripts/ensure-proxy-health.ps1 -PreferDirect
